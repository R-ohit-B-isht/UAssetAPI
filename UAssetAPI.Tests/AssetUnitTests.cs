...
namespace UAssetAPI.Tests
{
    ...
    public class AssetUnitTests
    {
        ...
        {
            TestJsonOnFile("PB_DT_RandomizerRoomCheck.uasset", EngineVersion.VER_UE5_3, Path.Combine("TestManyAssets", "Bloodstained"));
            TestJsonOnFile("m02VIL_004_Gimmick.umap", EngineVersion.VER_UE5_3, Path.Combine("TestManyAssets", "Bloodstained"));
            TestJsonOnFile("Staging_T2.umap", EngineVersion.VER_UE5_3, Path.Combine("TestManyAssets", "Astroneer"));
            TestJsonOnFile("Items.uasset", EngineVersion.VER_UE5_3); // string table
            //TestJsonOnFile("ABP_SMG_A.uasset", UE4Version.VER_UE5_3);
            TestJsonOnFile("WPN_LockOnRifle.uasset", EngineVersion.VER_UE5_3);
            TestJsonOnFile("Map_FrontEnd_Hotel_LS_Night.umap", EngineVersion.VER_UE5_3);
            TestJsonOnFile("AssetDatabase_AutoGenerated.uasset", EngineVersion.VER_UE5_3);
            TestJsonOnFile("RaceSimDataAsset.uasset", EngineVersion.VER_UE5_3);
            TestJsonOnFile("TurboAcres_Environment.uasset", EngineVersion.VER_UE5_3);
            TestJsonOnFile("MGA_HeavyWeapon_Parent.uasset", EngineVersion.VER_UE5_3, "TestJson", "Outriders.usmap");
        }
